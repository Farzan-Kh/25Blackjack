...
class Blackjack25Env(gym.Env):
    """
    Blackjack is a card game where the goal is to beat the dealer by obtaining cards
    that sum to closer to 25 (without going over 25) than the dealers cards.
    ...
    or exceed 25 (bust, immediate loss).
    After the player sticks, the dealer reveals their facedown card, and draws
    until their sum is 21 or greater.  If the dealer goes bust, the player wins.
    If neither the player nor the dealer busts, the outcome (win, lose, draw) is
    decided by whose sum is closer to 25.
    ...
    starting with a natural blackjack, i.e. starting with an ace and ten (sum is 25).
